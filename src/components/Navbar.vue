<template>
  <nav
    class="bg-white text-gray-800 flex py-4 px-8 justify-between border-b z-50"
  >
    <div class="flex">
    ...
    <div class="flex my-auto">
      ...
      <div class="my-auto flex">
        <dropdown-menu class="my-auto">
          <div class="flex">
            <div
              class="my-auto bg-gray-200 mr-3 rounded-full border-2 border-gray-200 overflow-hidden select-none"
            >
              <img
                :src="user.photo_url"
                class="select-none h-6"
                :alt="user.name"
              />
            </div>
